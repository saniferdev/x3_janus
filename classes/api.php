...
Class API{
    ...
    public function getRest($url,$key){
        ...
        echo $date = date("d-m-Y H:i:s",strtotime($this->getDate()));
    ...
    public function insertDocument_Ligne($receipt_number,$created_date,$orderby_code,$ligne,$reference,$quantity,$depot,$memo_content){
